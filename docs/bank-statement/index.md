...
签证申请、贷款、租房等场景常需提供银行流水（Bank Statement）。本文介绍各类银行电子流水的获取方式。

::: tip
电子流水通常可直接下载 PDF 或导出为银行盖章文件，建议提前确认受理方是否接受电子版。
:::
...
- 流水通常需覆盖最近 3～6 个月，具体以签证或受理方要求为准
- 部分机构要求银行盖章的原件，需前往网点打印并盖章
- 电子流水请确保信息完整、清晰，并保留可追溯的记录
