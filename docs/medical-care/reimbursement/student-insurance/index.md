...
![Studentsafe 门户首页 - 勾选条款后点击 Start a new claim](./images/image_1.png)
...
![填写个人信息](./images/image_2.png)

### 3. 选择理赔类型

选择 **MEDICAL EXPENSE**（医疗费用）。

![选择医疗费用理赔](./images/image_3.png)
...
![上传 Tax Invoice 和 Consultation Note](./images/image_4.png)

### 6. 声明与授权

阅读 **Declaration** 内容，勾选/确认信息真实无误，填写姓名、学生 ID、日期，然后点击 **NEXT STEP**。

![Declaration 声明页](./images/image_6.png)
